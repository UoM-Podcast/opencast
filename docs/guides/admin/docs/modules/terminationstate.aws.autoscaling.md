...
This page documents the configuration for Opencast module **matterhorn-terminationstate-aws**.  This
...
The Opencast AWS Autoscaling Termination State Service configuration can be found in the
`org.opencastproject.terminationstate.aws.AutoScalingTerminationStateService.cfg` file.

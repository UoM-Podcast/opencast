 ...
 * @author franck
 */
public class GoogleSpeechTranscriptionDatabaseTest {
  ...
  public void setUp() throws Exception {
    ...
    database.setEntityManagerFactory(
            newTestEntityManagerFactory("org.opencastproject.transcription.googlespeech.persistence"));
  ...
  public void testUpdateJobControlToTranscriptionComplete() throws Exception {
    ...
    Assert.assertEquals(MP_ID, j.getMediaPackageId());
    Assert.assertEquals(TRACK_ID, j.getTrackId());
    Assert.assertEquals(GoogleSpeechTranscriptionJobControl.Status.TranscriptionComplete.name(), j.getStatus());

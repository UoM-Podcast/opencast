...
public class GoogleSpeechTranscriptionServiceTest {
  ...
  public void setUp() throws Exception {
    ...
    GoogleSpeechTranscriptionService.invalidToken = "1";
    ...
    orgProps.put(GoogleSpeechTranscriptionService.ADMIN_URL_PROPERTY, "http://ADMIN_SERVER");
  ...
  public void testCreateRecognitionsJob() throws Exception {
    ...
    Assert.assertEquals(GoogleSpeechTranscriptionJobControl.Status.Progress.name(), j.getStatus());
  }
  ...
  public void testTranscriptionDone() throws Exception {
    ...
    database.storeJobControl(MP_ID, TRACK_ID, JOB_ID, GoogleSpeechTranscriptionJobControl.Status.Progress.name(), TRACK_DURATION);
    ...
    GoogleSpeechTranscriptionJobControl job = database.findByJob(JOB_ID);
    Assert.assertNotNull(job);
    Assert.assertEquals(GoogleSpeechTranscriptionJobControl.Status.TranscriptionComplete.name(), job.getStatus());
  ...
  public void testTranscriptionError() throws Exception {
    ...
    GoogleSpeechTranscriptionJobControl job = database.findByJob(JOB_ID);
    Assert.assertNotNull(job);
    Assert.assertEquals(GoogleSpeechTranscriptionJobControl.Status.Error.name(), job.getStatus());
  ...
  public void testWorkflowDispatcherRunTranscriptionCompletedState() throws Exception {
    ...
    GoogleSpeechTranscriptionJobControl job = database.findByJob(JOB_ID);
    Assert.assertNotNull(job);
    Assert.assertEquals(GoogleSpeechTranscriptionJobControl.Status.Closed.name(), job.getStatus());
  }
  ...
  public void testWorkflowDispatcherRunProgressState() throws Exception {
    ...
    database.storeJobControl(MP_ID, TRACK_ID, JOB_ID, GoogleSpeechTranscriptionJobControl.Status.Progress.name(), 0);
    database.storeJobControl(MP_ID, "audioTrack2", "jobId2", GoogleSpeechTranscriptionJobControl.Status.Progress.name(),
            TRACK_DURATION);
    database.storeJobControl("mpId2", "audioTrack3", "jobId3", GoogleSpeechTranscriptionJobControl.Status.Progress.name(),
            TRACK_DURATION);
  ...
  public void testWorkflowDispatcherJobNotFound() throws Exception {
    ...
    GoogleSpeechTranscriptionJobControl j = database.findByJob(JOB_ID);
    Assert.assertNotNull(j);
    Assert.assertEquals(GoogleSpeechTranscriptionJobControl.Status.Canceled.toString(), j.getStatus());
    EasyMock.verify(smtpService);
  }

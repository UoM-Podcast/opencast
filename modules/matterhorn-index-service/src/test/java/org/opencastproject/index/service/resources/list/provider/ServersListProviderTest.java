...
public class ServersListProviderTest {
  ...
  public void testListNames() throws ListProviderException {
    ...
    assertEquals(4, serverListProvider.getList(ServersListProvider.LIST_NODE_NAME, query, null).size());
  ...
  public void testNodeNameList() throws ListProviderException {
    ...
    Map<String, String> list = serverListProvider.getList(ServersListProvider.LIST_NODE_NAME, query, null);

 ...
 *
 */
public class RequirementServiceException extends Exception {
   ...
   */
  public RequirementServiceException(String message) {
    super(message);
  }
   ...
   */
  public RequirementServiceException(Throwable cause) {
    super(cause);
  }
   ...
   */
  public RequirementServiceException(String message, Throwable cause) {
    super(message, cause);
  }
}

...
public class WorkflowServiceImplTest {
  ...
  public void setUp() throws Exception {
    ...
    serviceRegistry.registerHost(REMOTE_HOST, REMOTE_HOST, "remote", Runtime.getRuntime().totalMemory(), Runtime.getRuntime().availableProcessors(), Runtime.getRuntime().availableProcessors());

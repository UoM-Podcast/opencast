...
public class ArchiveStorageMoveOperationHandler extends AbstractWorkflowOperationHandler {

  private static final Logger logger = LoggerFactory.getLogger(ArchiveStorageMoveOperationHandler.class);

  /** The asset manager. */
  private OpencastArchiveJobProducer tsamjp;

  /** OSGi DI */
  public void setJobProducer(OpencastArchiveJobProducer tsamjp) {
    this.tsamjp = tsamjp;
  }
  ...
  public WorkflowOperationResult start(WorkflowInstance workflowInstance, JobContext context)
    ...
    if (null != targetVersion) {
      Version version;
      try {
        version = Version.version(Long.parseLong(targetVersion));

...
angular.module('LocalStorageModule').value('prefix', 'editNg');
angular.module('editNg', [
    'angularFileUpload',
    ...
    'editNg.filters',
    'editNg.resources',
    'editNg.services.language',
    'editNg.services.table',
    'editNg.services.modal',
    'editNg.directives',
    'mgo-angular-wizard',
    'opencast.directives'
...
.config(['$translateProvider', function ($translateProvider) {
    var options = {
        'prefix': 'org/opencastproject/editui/languages/lang-',
        'suffix': '.json'
    };

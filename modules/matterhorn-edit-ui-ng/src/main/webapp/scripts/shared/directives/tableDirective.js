/**
 * @ngdoc directive
 * @name editNg.directives.editNgTable
 * @description
 ...
 * * Listens to changes to any filter values (see editNg.directives.editNgTableFilter).
 *
 * Future features:
 * * Pagination integration with the resource (records per page and offset).
 *
 * @example
 * <edit-ng-table="" table="table" />
 */
angular.module('editNg.directives')
.directive('editNgTable', ['Storage', '$translate', function (Storage, $translate) {

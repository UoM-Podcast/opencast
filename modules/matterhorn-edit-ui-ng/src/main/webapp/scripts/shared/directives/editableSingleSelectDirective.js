/**
 * @ngdoc directive
 * @name ng.directive:editNgEditableSingleSelect
 *
 * @description
 ...
 * @example
   <doc:example>
     <doc:source>
      <div edit-ng-editable-single-select params="params" save="save" collection="collection"></div>
     </doc:source>
   </doc:example>
 */
angular.module('editNg.directives')
.directive('editNgEditableSingleSelect', ['$timeout', function ($timeout) {
    return {
        restrict: 'A',

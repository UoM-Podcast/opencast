/**
 * @ngdoc directive
 * @name ng.directive:editNgEditableMultiSelect
 *
 * @description
 ...
 * @example
   <doc:example>
     <doc:source>
      <div edit-ng-editable-multi-select params="params" save="save" collection="collection"></div>
     </doc:source>
   </doc:example>
 */
angular.module('editNg.directives')
.directive('editNgEditableMultiSelect', ['$timeout', function ($timeout) {
    return {
        restrict: 'A',

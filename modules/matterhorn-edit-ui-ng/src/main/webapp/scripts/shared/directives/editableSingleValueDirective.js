/**
 * @ngdoc directive
 * @name ng.directive:editNgEditableSingleValue
 *
 * @description
 ...
 * @example
   <doc:example>
     <doc:source>
      <div edit-ng-editable-single-value params="params" save="save"></div>
     </doc:source>
   </doc:example>
 */
angular.module('editNg.directives')
.directive('editNgEditableSingleValue', ['$timeout', 'JsHelper', function ($timeout, JsHelper) {
    return {
        restrict: 'A',

/**
 * @ngdoc directive
 * @name ng.directive:editNgEditableMultiValue
 *
 * @description
 ...
 * @example
   <doc:example>
     <doc:source>
      <div edit-ng-editable-multi-value params="params" save="save"></div>
     </doc:source>
   </doc:example>
 */
angular.module('editNg.directives')
.directive('editNgEditableMultiValue', ['$timeout', function ($timeout) {
    return {
        restrict: 'A',

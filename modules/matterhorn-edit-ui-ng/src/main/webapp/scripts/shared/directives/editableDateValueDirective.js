/**
 * @ngdoc directive
 * @name ng.directive:editNgEditableDateValue
 *
 * @description
 ...
 * @example
 <doc:example>
 <doc:source>
 <div edit-ng-editable-date params="params" save="save"></div>
 </doc:source>
 </doc:example>
 */
angular.module('editNg.directives')
.directive('editNgEditableDateValue', ['$timeout', function ($timeout) {
    return {
        restrict: 'A',

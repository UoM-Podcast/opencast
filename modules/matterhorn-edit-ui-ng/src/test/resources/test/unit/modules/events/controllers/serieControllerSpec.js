describe('Serie controller', function () {
    ...
    beforeEach(function () {
        ...
        $httpBackend.whenGET('/edit-ng/series/4581/metadata.json')
            .respond(JSON.stringify(getJSONFixture('edit-ng/series/4581/metadata.json')));
        $httpBackend.whenGET('/edit-ng/series/4581/events.json')
            .respond(JSON.stringify(getJSONFixture('edit-ng/series/4581/events.json')));
        $httpBackend.whenGET('/edit-ng/series/4581/access.json').respond(JSON.stringify(getJSONFixture('edit-ng/series/4581/access.json')));
        $httpBackend.whenGET('/edit-ng/themes/themes.json').respond('{}');
        $httpBackend.whenGET('/edit-ng/series/4581/theme.json').respond(getJSONFixture('edit-ng/series/4581/theme.json'));
        $httpBackend.whenGET('/edit-ng/series/4581/participation.json').respond(getJSONFixture('edit-ng/series/4581/participation.json'));
        $httpBackend.whenPUT('/edit-ng/series/4581/theme').respond('{}');
        $httpBackend.whenGET('/edit-ng/resources/THEMES.NAME.json').respond({1001: 'Heinz das Pferd', 1002: 'Full Fledged', 401: 'Doc Test'});
        $httpBackend.whenGET('/edit-ng/resources/ACL.json').respond('{}');
        $httpBackend.whenGET('/edit-ng/resources/ACL.ACTIONS.json').respond('{}');
        $httpBackend.whenGET('/edit-ng/resources/ROLES.json?filter=role_target:ACL&limit=100&offset=0').respond('{"ROLE_ANONYMOUS": "ROLE_ANONYMOUS"}');
        $httpBackend.whenGET('/edit-ng/resources/ROLES.json?filter=role_target:ACL&limit=100&offset=3').respond('{}');
    ...
    describe('retrieving metadata catalogs', function () {
        ...
        beforeEach(function () {
            catalogs = getJSONFixture('edit-ng/series/4581/metadata.json');
            $httpBackend.flush();
    ...
    describe('#metadataSave', function () {
        ...
        describe('catalog selection', function () {
            ...
            beforeEach(function () {
                ...
                $httpBackend.expectPUT('/edit-ng/series/4581/metadata').respond(200);
            });

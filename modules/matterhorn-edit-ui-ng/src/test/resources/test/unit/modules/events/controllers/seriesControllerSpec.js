describe('Series controller', function () {
    ...
    describe('#delete', function () {
        ...
        it('reloads series after deletion', function () {
            $httpBackend.expectGET('/edit-ng/resources/series/filters.json').respond('[]');
            $httpBackend.expectDELETE('/edit-ng/series/12').respond('12');
            $httpBackend.expectGET('/edit-ng/series/series.json?limit=10&offset=0').respond(JSON.stringify(getJSONFixture('edit-ng/series/series.json')));

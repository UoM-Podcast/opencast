describe('ACL controller', function () {
    ...
    describe('#delete', function () {
        ...
        it('reloads acls after deletion', function () {
            $httpBackend.expectGET('/edit-ng/resources/acls/filters.json').respond('[]');
            $httpBackend.expectDELETE('/edit-ng/acl/454').respond();
            $httpBackend.expectGET('/edit-ng/acl/acls.json?limit=10&offset=0').respond(JSON.stringify(getJSONFixture('edit-ng/acl/acls.json')));

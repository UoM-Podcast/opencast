describe('User controller', function () {
    ...
    beforeEach(function () {
        ...
        $httpBackend.whenGET('/edit-ng/users/users.json').respond(JSON.stringify(getJSONFixture('edit-ng/users/users.json')));
        $httpBackend.whenGET('/roles/roles.json').respond(JSON.stringify(getJSONFixture('roles/roles.json')));
        $httpBackend.whenGET('/edit-ng/users/matterhorn_system_account.json')
            .respond(JSON.stringify(getJSONFixture('edit-ng/users/matterhorn_system_account.json')));
        $httpBackend.whenGET('/edit-ng/resources/ROLES.json?filter=role_target:USER&limit=0&offset=0').respond('{}');
    ...
    describe('when editing', function () {
        ...
        describe('with a manageable user', function () {
            ...
            beforeEach(function () {
                ...
                $httpBackend.whenGET('/edit-ng/users/admin.json')
                    .respond(JSON.stringify(getJSONFixture('edit-ng/users/admin.json')));
                $controller('UserCtrl', {$scope: $scope});
    ...
    describe('#submit', function () {
        ...
        describe('when editing', function () {
            ...
            describe('with success', function () {
                beforeEach(function () {
                    $httpBackend.whenPUT('/edit-ng/users/test.json')
                        .respond(200);
        ...
        describe('when creating', function () {
            ...
            describe('with success', function () {
                beforeEach(function () {
                    $httpBackend.whenPOST('/edit-ng/users')
                        .respond(200);
                    $scope.submit();
                    $httpBackend.flush();
                });

describe('User Blacklist Controller', function () {
    ...
    beforeEach(inject(function ($rootScope, _$controller_, _$httpBackend_, _Table_, _Modal_, _Notifications_) {
        ...
        $controller('UserblacklistCtrl', {$scope: $scope});
    }));

    beforeEach(function () {
        jasmine.getJSONFixtures().fixturesPath = 'base/app/GET';
        $httpBackend.whenGET('/edit-ng/resources/BLACKLISTS.USERS.REASONS.json')
            .respond('{}');
        $httpBackend.whenGET('/edit-ng/users/users.json')

describe('New Series Controller', function () {
    ...
    describe('#submit', function () {
        beforeEach(function () {
            $httpBackend.whenGET('/edit-ng/resources/THEMES.NAME.json').respond('{}');
            $httpBackend.whenGET('/edit-ng/series/new/metadata').respond('{}');
            ...
            $httpBackend.whenGET('/edit-ng/series/new/themes').respond('{}');
        ...
        it('saves collected userdata', function () {
            $httpBackend.expectPOST('/edit-ng/series/new', function (data) {
        ...
        describe('on success', function () {
            beforeEach(function () {
                $httpBackend.whenPOST('/edit-ng/series/new').respond(201);
            });
        ...
        describe('on error', function () {
            beforeEach(function () {
                $httpBackend.whenPOST('/edit-ng/series/new').respond(500);

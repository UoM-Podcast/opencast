describe('Tools Edit controller', function () {
    ...
    beforeEach(function () {
        ...
        $httpBackend.whenGET('/edit-ng/tools/5681/editor.json')
            .respond(JSON.stringify(getJSONFixture('edit-ng/tools/40518/editor.json')));
    });
    ...
    describe('#submit', function () {
        ...
        it('saves the cutting state', function () {
            $httpBackend.expectPOST('/edit-ng/tools/5681/editor.json').respond(201);
            $scope.submit();
            $httpBackend.flush();
        });
        ...
        describe('on success', function () {
            beforeEach(function () {
                $httpBackend.whenPOST('/edit-ng/tools/5681/editor.json').respond(201);
            });
        ...
        describe('on error', function () {
            beforeEach(function () {
                $httpBackend.whenPOST('/edit-ng/tools/5681/editor.json').respond(500);
            });

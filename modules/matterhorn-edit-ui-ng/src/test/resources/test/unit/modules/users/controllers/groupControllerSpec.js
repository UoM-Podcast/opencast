describe('Group controller', function () {
    ...
    beforeEach(function () {
        ...
        $httpBackend.whenGET('/edit-ng/resources/ROLES.json?filter=role_target:USER&limit=0&offset=0').respond(JSON.stringify(getJSONFixture('roles/roles.json')));
        $httpBackend.whenGET('/edit-ng/resources/USERS.INVERSE.WITH.USERNAME.json').respond(JSON.stringify(getJSONFixture('edit-ng/resources/USERS.INVERSE.WITH.USERNAME.json')));

describe('Bulk Delete controller', function () {
    ...
    beforeEach(function () {
        ...
        $httpBackend.whenGET('/edit-ng/event/new/processing?tags=delete-ng').respond(getJSONFixture('edit-ng/event/new/processing'));
        $httpBackend.whenGET('public/org/opencastproject/editui/languages/lang-en_US.json').respond({});
        $httpBackend.whenPOST('/edit-ng/tasks/new').respond(201);
    });

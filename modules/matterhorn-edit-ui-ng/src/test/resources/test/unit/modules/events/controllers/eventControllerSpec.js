describe('Event controller', function () {
    ...
    beforeEach(function () {
        ...
        $httpBackend.whenGET('/edit-ng/event/40518/comments')
            .respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/comments')));
        $httpBackend.whenGET('/edit-ng/event/40518/metadata.json')
            .respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/metadata.json')));
        $httpBackend.whenGET('/edit-ng/event/40518/general.json').respond({});
        $httpBackend.whenGET('/edit-ng/event/40518/asset/media/media.json').respond({});
        $httpBackend.whenGET('/edit-ng/event/40518/asset/attachment/attachments.json').respond({});
        $httpBackend.whenGET('/edit-ng/event/40518/asset/catalog/catalogs.json').respond({});
        $httpBackend.whenGET('/edit-ng/event/40518/asset/publication/publications.json').respond({});
        $httpBackend.whenGET('/edit-ng/event/40518/asset/assets.json').respond({});
        $httpBackend.whenGET('/edit-ng/event/40518/workflows.json').respond({});
        $httpBackend.whenGET('/edit-ng/event/40518/access.json')
            .respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/access.json')));
        $httpBackend.whenGET('/edit-ng/event/40518/participation.json').respond({});
        $httpBackend.whenGET('/edit-ng/resources/components.json').respond({});
        $httpBackend.whenGET('/edit-ng/resources/ACL.json').respond({});
        $httpBackend.whenGET('/edit-ng/resources/ACL.ACTIONS.json').respond({});
        $httpBackend.whenGET('/edit-ng/resources/PUBLICATION.CHANNEL.LABELS.json').respond({});
        $httpBackend.whenGET('/edit-ng/resources/PUBLICATION.CHANNEL.ICONS.json').respond({});
        $httpBackend.whenGET('/edit-ng/resources/ROLES.json').respond({});
        $httpBackend.whenGET('/edit-ng/resources/PUBLICATION.CHANNEL.LABELS.json').respond({});
        $httpBackend.whenGET('/edit-ng/resources/PUBLICATION.CHANNEL.ICONS.json').respond({});
        $httpBackend.whenGET('/edit-ng/event/new/processing?tags=schedule-ng').respond({});
        $httpBackend.whenGET('/edit-ng/event/40518/hasActiveTransaction').respond('false');
        $httpBackend.whenGET('/edit-ng/capture-agents/agents.json').respond(JSON.stringify({"results":[],"total":0}));
    ...
    describe('deleting a comment', function () {
        it('sends a DELETE request', function () {
            $httpBackend.expectDELETE('/edit-ng/event/40518/comment/2').respond({});
    ...
    describe('creating a new comment', function () {
        ...
        it('sends a POST request', function () {
            $httpBackend.expectPOST('/edit-ng/event/40518/comment', function (data) {
        ...
        it('updates existing comments', function () {
            $httpBackend.whenPOST('/edit-ng/event/40518/comment').respond({});
            $httpBackend.expectGET('/edit-ng/event/40518/comments')
                .respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/comments')));
            $scope.comment();
            $httpBackend.flush();
        });
    ...
    describe('replying to a comment', function () {
        beforeEach(function () {
            $scope.replyTo(getJSONFixture('edit-ng/event/40518/comments')[0]);
        ...
        it('sends a POST request resolving the issue', function () {
            $httpBackend.expectPOST('/edit-ng/event/40518/comment/1/reply', function (data) {
    ...
    describe('retrieving metadata catalogs', function () {
        ...
        beforeEach(function () {
            catalogs = getJSONFixture('edit-ng/event/40518/metadata.json');
            $httpBackend.flush();
    ...
    describe('#metadataSave', function () {
        ...
        it('marks the saved attribute as saved', function () {
            $scope.metadataSave('title', undefined, catalog);
            $httpBackend.whenPUT('/edit-ng/event/40518/metadata')
        ...
        it('calls the provided callback on success', function () {
            ...
            $httpBackend.whenPUT('/edit-ng/event/40518/metadata').respond(200);
            $httpBackend.flush();
        ...
        describe('getSaveFn', function () {
            ...
            beforeEach(function () {
                ...
                $httpBackend.expectPUT('/edit-ng/event/40518/metadata').respond(200);
            });

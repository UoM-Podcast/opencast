describe('Servers controller', function () {
    ...
    describe('#setMaintenanceMode', function () {
        beforeEach(function () {
            $httpBackend.whenGET('/edit-ng/server/servers.json?limit=10&offset=0')
                .respond(JSON.stringify(getJSONFixture('edit-ng/server/servers.json')));
            $httpBackend.whenGET('/edit-ng/resources/servers/filters.json').respond('{}');

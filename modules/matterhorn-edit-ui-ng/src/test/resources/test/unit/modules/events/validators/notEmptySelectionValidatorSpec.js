describe('editNg.modules.events.validators.notEmptySelectionValidator', function () {
    ...
    beforeEach(function () {
        $rootScope.listoptions = getJSONFixture('edit-ng/event/new/processing');
        $rootScope.somemodel = {};
        $rootScope.processing = {
            ud: {}
        };
        //$httpBackend.whenGET('/edit-ng/themes/themes.json').respond(JSON.stringify(getJSONFixture('edit-ng/themes/themes.json')));

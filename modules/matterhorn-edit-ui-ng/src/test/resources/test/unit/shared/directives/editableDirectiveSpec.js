describe('editNg.directives.editNgEditable', function () {
    ...
    describe('for a read-only value', function () {
        beforeEach(function () {
            ...
            element = $compile('<div edit-ng-editable="" params="params"></div>')($rootScope);
            $rootScope.$digest();
        });
    ...
    describe('for a value with insufficient rights', function () {
        beforeEach(function () {
            ...
            element = $compile('<div edit-ng-editable="" params="params" requiredRole="ROLE_NOOP"></div>')($rootScope);
            $rootScope.$digest();
        });
    ...
    describe('for a multi select', function () {
        beforeEach(function () {
            $httpBackend.whenGET('/edit-ng/resources/users.json').respond(JSON.stringify({

describe('Event Metadata API Resource', function () {
    ...
    describe('#get', function () {
        it('provides nested JSON data', function () {
            ...
            $httpBackend.expectGET('/edit-ng/event/40518/metadata.json').respond(JSON.stringify(metadataResponse));
    ...
    describe('#save', function () {
        it('sends an array of metadata', function () {
            ...
            $httpBackend.expectPUT('/edit-ng/event/40518/metadata', function (data) {

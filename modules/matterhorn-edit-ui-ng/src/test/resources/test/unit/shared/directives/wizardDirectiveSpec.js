...
xdescribe('editNg.directives.wizardDirective', function () {
    ...
    beforeEach(function () {
        $httpBackend.whenGET('/edit-ng/resources/components.json').respond(JSON.stringify(getJSONFixture('edit-ng/resources/components.json')));
        $httpBackend.whenGET('/edit-ng/resources/ACL.json').respond(JSON.stringify(getJSONFixture('edit-ng/resources/ACL.json')));
        $httpBackend.whenGET('/edit-ng/event/new/metadata').respond(JSON.stringify(getJSONFixture('edit-ng/event/new/metadata')));
        $httpBackend.whenGET('/edit-ng/capture-agents/agents.json?inputs=true').respond(JSON.stringify(getJSONFixture('edit-ng/capture-agents/agents.json')));
...
//            element = $compile('<edit-ng-wizard data-name="new-event" data-states="states"></edit-ng-wizard>')($scope);
//            $parentScope.$digest();
//            $scope.$digest();
//            $rootScope.$digest();
        });

describe('Event Workflow Operation API Resource', function () {
    ...
    describe('#get', function () {
        beforeEach(function () {
            ...
            $httpBackend.whenGET('/edit-ng/event/40518/workflows/8695/operations/1')
                .respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/workflows/8695/operations/1303.json')));
        });

        it('queries the API', function () {
            $httpBackend.expectGET('/edit-ng/event/40518/workflows/8695/operations/1').respond(getJSONFixture('edit-ng/event/40518/workflows/8695/operations/1303.json'));

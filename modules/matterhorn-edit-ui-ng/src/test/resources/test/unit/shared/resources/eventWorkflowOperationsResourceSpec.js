describe('Event Workflow Operations API Resource', function () {
    ...
    describe('#get', function () {
        beforeEach(function () {
            ...
            $httpBackend.whenGET('/edit-ng/event/40518/workflows/8695/operations.json')
                .respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/workflows/8695/operations.json')));
        });

        it('queries the API', function () {
            $httpBackend.expectGET('/edit-ng/event/40518/workflows/8695/operations.json');
    ...
    describe('#save', function () {
        it('sends an array of operations', function () {
            ...
            $httpBackend.expectPOST('/edit-ng/event/40518/workflows/8695/operations.json', metadataRequest.entries)
                .respond(200);

describe('Series Access API Resource', function () {
    ...
    describe('#get', function () {
        it('provides nested JSON data', function () {
            ...
            $httpBackend.expectGET('/edit-ng/series/20518/access.json').respond(JSON.stringify(accessResponse));
    ...
    describe('#save', function () {
        it('sends an array of metadata', function () {
            ...
            $httpBackend.expectPOST('/edit-ng/series/40518/access', function (data) {
                var expected = {
        ...
        it('handles empty requests gracefully', function () {
            $httpBackend.expectPOST('/edit-ng/series/access').respond(200);

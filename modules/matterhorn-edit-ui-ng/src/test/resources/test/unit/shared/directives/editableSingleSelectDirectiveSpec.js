describe('editNg.directives.editNgEditableSingleSelect', function () {
    ...
    beforeEach(function () {
        ...
        element = $compile('<div edit-ng-editable-single-select params="params" collection="collection" save="save"></div>')($rootScope);
        $rootScope.$digest();
    });

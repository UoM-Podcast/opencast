describe('editNg.directives.editNgTableFilter', function () {
    ...
    beforeEach(function () {
        ...
        $httpBackend.whenGET('/edit-ng/resources/furniture/filters.json').respond(JSON.stringify({
            color: {
                label: 'COLOR',
                type: 'select',
                options: {
        ...
        element = $compile('<div edit-ng-table-filter data-filters="filters" data-namespace="resource"></div>')($rootScope);
        $rootScope.$digest();

describe('Event Error Details API Resource', function () {
    ...
    it('provides the resource', function () {
        $httpBackend.expectGET('/edit-ng/event/831/workflows/612/errors/9371.json')
            .respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/workflows/8695/errors/9371.json')));

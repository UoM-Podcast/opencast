describe('Metadata Extended Step in New Series Wizard', function () {
    ...
    beforeEach(function () {
        ...
        $httpBackend.whenGET('/edit-ng/capture-agents/agents.json').respond(JSON.stringify(getJSONFixture('edit-ng/capture-agents/agents.json')));
    ...
    it('is not visible if there is no extended metadata available', function () {
        $httpBackend.whenGET('/edit-ng/series/new/metadata').respond(JSON.stringify(withoutExtendedMetadata));
        $httpBackend.flush();
        expect(NewSeriesMetadataExtended.visible).toBeFalsy();
    });

    it('is visible if there is extended metadata available', function () {
        $httpBackend.whenGET('/edit-ng/series/new/metadata').respond(JSON.stringify(withExtendedMetadata));
        $httpBackend.flush();

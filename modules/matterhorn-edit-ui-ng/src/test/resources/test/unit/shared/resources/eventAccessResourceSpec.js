describe('Event Access API Resource', function () {
    ...
    describe('#get', function () {
        beforeEach(function () {
            ...
            $httpBackend.whenGET('/edit-ng/event/40518/access.json').respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/access.json')));
        });

        it('queries the group API', function () {
            $httpBackend.expectGET('/edit-ng/event/40518/access.json').respond(getJSONFixture('edit-ng/event/40518/access.json'));
            EventAccessResource.get({ id: '40518'});
        });

        it('returns the parsed JSON', function () {
            $httpBackend.whenGET('/edit-ng/event/40518/access.json').respond(getJSONFixture('edit-ng/event/40518/access.json'));
    ...
    describe('#save', function () {
        it('sends an array of metadata', function () {
            ...
            $httpBackend.expectPOST('/edit-ng/event/40518/access', function (data) {
        ...
        it('handles empty requests gracefully', function () {
            $httpBackend.expectPOST('/edit-ng/event/access').respond(200);

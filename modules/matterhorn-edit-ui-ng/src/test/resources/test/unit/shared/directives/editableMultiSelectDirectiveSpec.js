describe('editNg.directives.editNgEditableMultiSelect', function () {
    ...
    beforeEach(function () {
        ...
        element = $compile('<div edit-ng-editable-multi-select params="params" collection="collection" save="save"></div>')($rootScope);
        $rootScope.$digest();
    });

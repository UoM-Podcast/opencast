describe('Event General API Resource', function () {
    ...
    describe('#get', function () {
        beforeEach(function () {
            ...
            $httpBackend.whenGET('/edit-ng/event/40518/general.json').respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/general.json')));
        });

        it('queries the general API', function () {
            $httpBackend.expectGET('/edit-ng/event/40518/general.json').respond(getJSONFixture('edit-ng/event/40518/general.json'));
            EventGeneralResource.get({ id: '40518'});
            $httpBackend.flush();
        });

        it('returns the parsed JSON', function () {
            $httpBackend.whenGET('/edit-ng/event/40518/general.json').respond(getJSONFixture('edit-ng/event/40518/general.json'));

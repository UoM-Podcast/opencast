describe('Event Workflow Details API Resource', function () {
    ...
    describe('#get', function () {
        beforeEach(function () {
            ...
            $httpBackend.whenGET('/edit-ng/events/40518/workflows/8695.json')
                .respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/workflows/8695.json')));
        });

        it('queries the group API', function () {
            $httpBackend.expectGET('/edit-ng/event/40518/workflows/8695.json')
                .respond(JSON.stringify(getJSONFixture('edit-ng/event/40518/workflows/8695.json')));

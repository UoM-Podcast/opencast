...
describe('adminNg.services.language', function () {
    ...
    beforeEach(function () {
        ...
        $httpBackend.whenGET('public/org/opencastproject/editui/languages/lang-en_US.json').respond('');
        $httpBackend.flush();
    });
    ...
    describe('#loadLanguageFromServer', function () {
        ...
        it('rejects on errors', function () {
            ...
            $httpBackend.whenGET('public/org/opencastproject/editui/languages/lang-ja_JP.json').respond(404);
    ...
    describe('#changeLanguage', function () {
        ...
        it('requests the given language from the server', function () {
            $httpBackend.whenGET('public/org/opencastproject/editui/languages/lang-de_DE.json').respond('');
    ...
    describe('#configureFromServer', function () {
        ...
        describe('on success', function () {
            beforeEach(function () {
                ...
                $httpBackend.expectGET('public/org/opencastproject/editui/languages/lang-en_US.json');
            });

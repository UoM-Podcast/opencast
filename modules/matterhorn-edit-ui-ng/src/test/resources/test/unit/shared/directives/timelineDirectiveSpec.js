describe('editNg.directives.timelineDirective', function () {
    ...
    beforeEach(function () {
        ...
        $rootScope.video = angular.copy(getJSONFixture('edit-ng/tools/40518/editor.json'));
        element = $compile('<div data-edit-ng-timeline="" data-video="video" data-player="player"/></div>')($rootScope);
        $rootScope.$digest();
    });
    ...
    describe('#move', function () {
        ...
        beforeEach(function () {
            $rootScope.video = angular.
                copy(getJSONFixture('edit-ng/tools/40518/editor.json'));
            $rootScope.$digest();

describe('Series API Resource', function () {
    ...
    describe('#query', function () {
        it('calls the series service', function () {
            $httpBackend.expectGET('/edit-ng/series/series.json')
                .respond(JSON.stringify(getJSONFixture('edit-ng/series/series.json')));
            SeriesResource.query();
            $httpBackend.flush();
        });

        it('flattens the JSON data received', function () {
            $httpBackend.whenGET('/edit-ng/series/series.json')
                .respond(JSON.stringify(getJSONFixture('edit-ng/series/series.json')));
    ...
    describe('#create', function () {
        ...
        it('handles empty requests gracefully', function () {
            $httpBackend.expectPOST('/edit-ng/series/new').respond(200);

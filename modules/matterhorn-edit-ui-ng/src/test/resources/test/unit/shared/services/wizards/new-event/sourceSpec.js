describe('Source Step in New Event Wizard', function () {
    ...
    beforeEach(function () {
        ...
        captureAgents = getJSONFixture('edit-ng/capture-agents/agents.json');
    });
    ...
    describe('conflict checking behaviour', function () {
        ...
        beforeEach(function () {
            ...
            $httpBackend.expectPOST('/edit-ng/event/new/conflicts').respond(409, conflictResponse);
            $httpBackend.whenGET('/edit-ng/capture-agents/agents.json?inputs=true').respond(JSON.stringify(captureAgents));
        ...
        it('becomes valid again if the conflict is removed', function () {
            $httpBackend.expectPOST('/edit-ng/event/new/conflicts').respond(203);

describe('Events API Resource', function () {
    ...
    describe('#query', function () {
        ...
        it('calls the events service', function () {
            $httpBackend.expectGET('/edit-ng/event/events.json')
        ...
        it('handles empty payload', function () {
            $httpBackend.expectGET('/edit-ng/event/events.json').respond('{ "results": []}');
            var data = EventsResource.query();
            $httpBackend.flush();
        ...
        it('handles payloads with one item', function () {
            $httpBackend.whenGET('/edit-ng/event/events.json').respond(JSON.stringify({
                results: {
                    source: 'archive',
                    id: '40518',
                    title: 'Test Title',

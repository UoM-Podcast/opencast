describe('Theme API Resource', function () {
    ...
    describe('ThemeResource', function () {
        ...
        describe('#delete', function(){
            ...
            it('executes delete request on delete()', function () {
                $httpBackend.expectDELETE('/edit-ng/themes/1').respond({});
        ...
        describe('#get', function(){
            ...
            beforeEach(function(){
                $httpBackend.whenGET('/edit-ng/themes/1.json').respond(JSON.stringify(theme));
    ...
    describe('ThemesResource', function () {
        ...
        it('executes get request on query()', function () {
            $httpBackend.expectGET('/edit-ng/themes/themes.json').respond(JSON.stringify(themesResponse));
    ...
    describe('ThemeUsageResource', function () {
        ...
        it('executes get request on query()', function () {
            $httpBackend.expectGET('/edit-ng/themes/2/usage.json').respond(JSON.stringify(seriesResponse));

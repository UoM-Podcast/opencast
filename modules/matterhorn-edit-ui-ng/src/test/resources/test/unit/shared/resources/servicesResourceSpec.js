describe('Services API Resource', function () {
    ...
    describe('#query', function () {
        ...
        it('calls the services service', function () {
            $httpBackend.expectGET('/edit-ng/services/services.json').respond(JSON.stringify(sampleJSON));
            ServicesResource.query();
            $httpBackend.flush();
        });

        it('flattens the JSON data received', function () {
            $httpBackend.whenGET('/edit-ng/services/services.json').respond(JSON.stringify(sampleJSON));

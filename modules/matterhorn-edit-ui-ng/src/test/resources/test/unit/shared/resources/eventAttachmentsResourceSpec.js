describe('Event Attachments API Resource', function () {
    ...
    describe('#get', function () {
        beforeEach(function () {
            ...
            $httpBackend.whenGET('/edit-ng/event/30112/asset/attachment/attachments.json')
            .respond(JSON.stringify(getJSONFixture('edit-ng/event/30112/asset/attachment/attachments.json')));
        });

        it('queries the group API', function () {
            $httpBackend.expectGET('/edit-ng/event/30112/asset/attachment/attachments.json')
            .respond(getJSONFixture('edit-ng/event/30112/asset/attachment/attachments.json'));

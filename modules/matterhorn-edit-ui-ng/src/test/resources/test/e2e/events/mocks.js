...
exports.httpBackendMock = function () {
    $.getScript('lib/angular/angular-mocks.js', function () {
        ...
        .run(function ($httpBackend) {
            ...
            $httpBackend.whenPOST('/edit-ng/event/40518/comment')
            ...
            $httpBackend.whenPOST('/edit-ng/event/40518/comment/1/reply')
            .respond(function (method, url, data) {
            ...
            $httpBackend.whenDELETE('/edit-ng/event/40518/comment/1')
            .respond(function (method, url, data) {
                comment.splice(0, 1);
                return [200, data, {}];
            });

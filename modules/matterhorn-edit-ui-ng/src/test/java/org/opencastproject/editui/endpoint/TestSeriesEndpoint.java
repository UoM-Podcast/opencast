...
public class TestSeriesEndpoint extends SeriesEndpoint {
  ...
  private AdminUISearchIndex edituiSearchIndex;
  ...
  public TestSeriesEndpoint() throws Exception {
    ...
    this.setIndex(edituiSearchIndex);
  ...
  private void setupIndex() throws SearchIndexException, IOException, IllegalStateException, ParseException {
    ...
    edituiSearchIndex = EasyMock.createMock(AdminUISearchIndex.class);
    ...
    EasyMock.expect(edituiSearchIndex.getByQuery(EasyMock.capture(captureSeriesSearchQuery)))
    ...
    EasyMock.expect(edituiSearchIndex.getByQuery(EasyMock.capture(captureEventSearchQuery)))
    ...
    EasyMock.expect(edituiSearchIndex.getByQuery(EasyMock.capture(captureThemeSearchQuery)))
    ...
    EasyMock.replay(edituiSearchIndex, item1, item2, item3, themeItem1, ascSeriesSearchResult, descSeriesSearchResult,

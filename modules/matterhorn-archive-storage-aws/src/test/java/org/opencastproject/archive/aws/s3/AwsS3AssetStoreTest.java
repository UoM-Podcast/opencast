...
import org.opencastproject.archive.aws.persistence.AwsAssetDatabaseImpl;
...
public class AwsS3AssetStoreTest {
  ...
  public void testPut() throws Exception {
    ...
    StoragePath path = new StoragePath(ORG_ID, MP_ID, Version.version(1L), ASSET_ID);
  ...
  public void testCopy() throws Exception {
    ...
    StoragePath path2 = new StoragePath(ORG_ID, MP_ID, Version.version(1L), ASSET_ID2);
  ...
  public void testGet() throws Exception {
    ...
    Option<InputStream> streamOpt = store.get(path);
  ...
  public void testDeleteWithVersion() throws Exception {
    ...
    StoragePath path2 = new StoragePath(ORG_ID, MP_ID, Version.version(2L), ASSET_ID);
    ...
    DeletionSelector versionSelector = DeletionSelector.del(ORG_ID, MP_ID, Version.version(1L));
  ...
  public void testDeleteNoneVersion() throws Exception {
    ...
    DeletionSelector mpSelector = DeletionSelector.delAll(ORG_ID, MP_ID);
  ...
  public void testDeleteNonExistentVersion() throws Exception {
    ...
    DeletionSelector versionSelector = DeletionSelector.del(ORG_ID, MP_ID, Version.version(2L));
  ...
  public void testDeleteLinkedAsset() throws Exception {
    ...
    // Copy asset, this should not generate any aws call, just a new mapping in the db
    StoragePath path2 = new StoragePath(ORG_ID, MP_ID2, Version.version(1L), ASSET_ID2);
    Assert.assertTrue(store.copy(path, path2));

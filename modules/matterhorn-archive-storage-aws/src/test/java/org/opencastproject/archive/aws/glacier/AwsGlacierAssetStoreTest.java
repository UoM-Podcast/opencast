...
public class AwsGlacierAssetStoreTest {
  ...
  public void testPut() throws Exception {
    StoragePath path = new StoragePath(ORG_ID, MP_ID, new Version(1L), ASSET_ID);
  ...
  public void testCopy() throws Exception {
    StoragePath path1 = new StoragePath(ORG_ID, MP_ID, new Version(1L), ASSET_ID);
    StoragePath path2 = new StoragePath(ORG_ID, MP_ID, new Version(1L), ASSET_ID2);

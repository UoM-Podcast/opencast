...
public final class RecordingQuery {
  ...
  private Option<ReviewStatus> reviewStatus = none();
  private Option<EmailStatus> emailStatus = none();
  private Option<Boolean> blacklisted = none();
  ...
  public RecordingQuery withOnlyBlacklisted() {
    this.blacklisted = some(true);
    return this;
  }

  public RecordingQuery withoutBlacklisted() {
    this.blacklisted = some(false);
    return this;
  }
  ...
  public RecordingQuery withReviewStatus(ReviewStatus status) {
    this.reviewStatus = Option.option(status);
    return this;
  }

  public RecordingQuery withEmailStatus(EmailStatus status) {
    this.emailStatus = Option.option(status);
    return this;
  }
  ...
  public Option<Boolean> isBlacklisted() {
    return blacklisted;
  }
  ...
  public Option<ReviewStatus> getReviewStatus() {
    return reviewStatus;
  }

  public Option<EmailStatus> getEmailStatus() {
    return emailStatus;
  }

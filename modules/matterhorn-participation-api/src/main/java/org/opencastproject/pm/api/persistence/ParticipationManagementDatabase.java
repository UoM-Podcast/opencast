...
public interface ParticipationManagementDatabase {
  ...
  long countCoursesByEmailState(Course.EmailStatus emailStatus) throws ParticipationManagementDatabaseException;
  ...
  long countWeeklyBlacklistedRecordings() throws ParticipationManagementDatabaseException;

  long countDailyBlacklistedRecordings() throws ParticipationManagementDatabaseException;
  ...
  long countTotalResponses() throws ParticipationManagementDatabaseException;

  long countConfirmedResponses() throws ParticipationManagementDatabaseException;

  long countQuarterConfirmedResponses() throws ParticipationManagementDatabaseException;

  long countDailyConfirmedResponses() throws ParticipationManagementDatabaseException;

  long countUnconfirmedResponses() throws ParticipationManagementDatabaseException;

  long countOptedOutResponses() throws ParticipationManagementDatabaseException;

  long countRecordingsByEmailState(EmailStatus emailStatus) throws ParticipationManagementDatabaseException;

  long countCourseRecordingsByEmailState(Course course, EmailStatus emailStatus) throws ParticipationManagementDatabaseException;

  long countRecordingsByReviewState(ReviewStatus reviewStatus) throws ParticipationManagementDatabaseException;
  ...
  List<EmailView> findRecordingsAsEmailView(EmailStatus status) throws ParticipationManagementDatabaseException;
  ...
  Recording reviewRecording(long id, ReviewStatus status) throws ParticipationManagementDatabaseException,
          NotFoundException;
  ...
  long countBlacklistedEventsByRoom(int roomId, long startTime, long endTime) throws ParticipationManagementDatabaseException, NotFoundException;
  ...
  long countBlacklistedCoursesByRoom(int roomId, long startTime, long endTime) throws ParticipationManagementDatabaseException, NotFoundException;

  List<Recording> findRecordingsByDateRangeAndRoom(long roomId, long startTime, long endTime)
          throws ParticipationManagementDatabaseException, NotFoundException;

  long countBlacklistedEventsByPerson(int personId, long startTime, long endTime) throws ParticipationManagementDatabaseException, NotFoundException;

  long countBlacklistedCoursesByPerson(int personId, long startTime, long endTime) throws ParticipationManagementDatabaseException, NotFoundException;
